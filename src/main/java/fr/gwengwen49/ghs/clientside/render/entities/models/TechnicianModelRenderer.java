package fr.gwengwen49.ghs.clientside.render.entities.models;
...
public class TechnicianModelRenderer<T extends LivingEntity> extends HumanoidModel<T>
{
    ...
    public TechnicianModelRenderer(ModelPart p_170821_, boolean p_170822_) {
